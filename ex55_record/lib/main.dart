...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _Fn? getRecorderFn() {
    if (!_mRecorderIsInited || !_mPlayer!.isStopped) {
      print('_mRecorderIsInited: $_mPlayerIsInited');
  ...
  _Fn? getPlaybackFn() {
    if (!_mPlayerIsInited || !_mPlayerbackReady || !_mRecorder!.isStopped) {
      return null;
    }
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: Row(children: [
              ElevatedButton(onPressed: getRecorderFn, child: Text(
          ...
          Container(
            ...
            child: Row(children: [
              ElevatedButton(onPressed: getPlaybackFn(), child: Text(
